...
public class ImageArchive {
    ...
    public static void rescaleImages(double xScale, double yScale){
        ...
        //Cards
            ...
            //Clubs
            scaledClubs2 = clubs2.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledClubs3 = clubs3.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledClubs4 = clubs4.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledClubs5 = clubs5.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledClubs6 = clubs6.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledClubs7 = clubs7.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledClubs8 = clubs8.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledClubs9 = clubs9.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledClubs10 = clubs10.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledClubsJ = clubsJ.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledClubsQ = clubsQ.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledClubsK = clubsK.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledClubsA = clubsA.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            //Diamonds
            scaledDiamonds2 = diamonds2.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledDiamonds3 = diamonds3.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledDiamonds4 = diamonds4.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledDiamonds5 = diamonds5.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledDiamonds6 = diamonds6.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledDiamonds7 = diamonds7.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledDiamonds8 = diamonds8.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledDiamonds9 = diamonds9.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledDiamonds10 = diamonds10.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledDiamondsJ = diamondsJ.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledDiamondsQ = diamondsQ.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledDiamondsK = diamondsK.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledDiamondsA = diamondsA.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            //Hearts
            scaledHearts2 = hearts2.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledHearts3 = hearts3.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledHearts4 = hearts4.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledHearts5 = hearts5.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledHearts6 = hearts6.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledHearts7 = hearts7.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledHearts8 = hearts8.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledHearts9 = hearts9.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledHearts10 = hearts10.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledHeartsJ = heartsJ.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledHeartsQ = heartsQ.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledHeartsK = heartsK.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledHeartsA = heartsA.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            //Spades
            scaledSpades2 = spades2.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledSpades3 = spades3.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledSpades4 = spades4.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledSpades5 = spades5.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledSpades6 = spades6.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledSpades7 = spades7.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledSpades8 = spades8.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledSpades9 = spades9.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledSpades10 = spades10.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledSpadesJ = spadesJ.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledSpadesQ = spadesQ.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledSpadesK = spadesK.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
            scaledSpadesA = spadesA.getScaledInstance((int)(104*xScale), (int)(145*yScale), Image.SCALE_SMOOTH);
    }

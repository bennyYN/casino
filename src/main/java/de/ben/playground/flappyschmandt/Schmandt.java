...
public class Schmandt {
    ...
    private Image player1 = new ImageIcon(getClass().getClassLoader().getResource("img/playground/flappyschmandt/player1.png")).getImage();
    private Image player2 = new ImageIcon(getClass().getClassLoader().getResource("img/playground/flappyschmandt/player2.png")).getImage();

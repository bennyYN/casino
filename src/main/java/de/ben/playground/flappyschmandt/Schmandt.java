...
public class Schmandt {
    ...
    private Image player1 = new ImageIcon("img/playground/flappyschmandt/player11.png").getImage();
    private Image player2 = new ImageIcon("img/playground/flappyschmandt/player12.png").getImage();

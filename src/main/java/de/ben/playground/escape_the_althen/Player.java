			...
			//WALKING PLAYER
				if(isWalking) {
					if(moveDirection == "up" || moveDirection == "down") {
						g.drawImage(new ImageIcon("img/playground/escapethealthen/graphics/creatures/player/walking/"+moveDirection+textureVariation2+".png").getImage(), (int)xScreenPos, (int)yScreenPos, (int)(16*scale), (int)(32*scale), null);
					}else {
